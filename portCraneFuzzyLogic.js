...
PortCraneFuzzyLogic.prototype.getVerticalMovement = function(distToShip, containerSpeedY, parallaxX){
    return this.verticalMovement.calc([distToShip, containerSpeedY, Math.abs(parallaxX)]);
}
